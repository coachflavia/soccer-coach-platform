...
export const miniKickersThemes = ["Pirates", "Space / Astronauts", "Zoo / Animals", "Superheroes", "Dinosaurs", "Cars / Racing", "Ocean", "Jungle", "Adventure", "Other / Custom"] as const;
